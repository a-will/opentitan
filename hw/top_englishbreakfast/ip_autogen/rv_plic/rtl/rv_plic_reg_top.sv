...
module rv_plic_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[83] = (reg_addr == RV_PLIC_IP_0_OFFSET);
    addr_hit[84] = (reg_addr == RV_PLIC_IP_1_OFFSET);
    addr_hit[85] = (reg_addr == RV_PLIC_IP_2_OFFSET);
    addr_hit[86] = (reg_addr == RV_PLIC_IE0_0_OFFSET);
    addr_hit[87] = (reg_addr == RV_PLIC_IE0_1_OFFSET);
    addr_hit[88] = (reg_addr == RV_PLIC_IE0_2_OFFSET);
    ...
    addr_hit[92] = (reg_addr == RV_PLIC_ALERT_TEST_OFFSET);
  end
  ...
  assign ie0_0_we = addr_hit[86] & reg_we & !reg_error;
  ...
  assign ie0_1_we = addr_hit[87] & reg_we & !reg_error;
  ...
  assign ie0_2_we = addr_hit[88] & reg_we & !reg_error;
  ...
  assign threshold0_we = addr_hit[89] & reg_we & !reg_error;

  assign threshold0_wd = reg_wdata[1:0];
  assign cc0_re = addr_hit[90] & reg_re & !reg_error;
  assign cc0_we = addr_hit[90] & reg_we & !reg_error;

  assign cc0_wd = reg_wdata[6:0];
  assign msip0_we = addr_hit[91] & reg_we & !reg_error;

  assign msip0_wd = reg_wdata[0];
  assign alert_test_we = addr_hit[92] & reg_we & !reg_error;
